...
module YAMLBlockHandler =
    ...
    /// </summary>
    and parseYamlContent (content: string) (context: MetascriptExecutionContext) : Result<Map<string, obj>, string> =
        try
    ...
    /// </summary>
    and processYamlData (yamlData: Map<string, obj>) (context: MetascriptExecutionContext) : string =
        let mutable output = []
    ...
    /// </summary>
    and processStatusSection (status: string) (context: MetascriptExecutionContext) : string =
        sprintf "Status updated: %s" status
    
    /// <summary>
    /// Processes a phase section
    /// </summary>
    and processPhaseSection (phase: string) (context: MetascriptExecutionContext) : string =
        sprintf "Phase set: %s" phase
    
    /// <summary>
    /// Processes a progress section
    /// </summary>
    and processProgressSection (progress: string) (context: MetascriptExecutionContext) : string =
        sprintf "Progress updated: %s" progress
    
    /// <summary>
    /// Processes an exploration section
    /// </summary>
    and processExplorationSection (exploration: string) (context: MetascriptExecutionContext) : string =
        sprintf "Exploration mode: %s" exploration
    
    /// <summary>
    /// Processes a recovery section
    /// </summary>
    and processRecoverySection (recovery: string) (context: MetascriptExecutionContext) : string =
    ...
    /// </summary>
    and generateYamlContent (status: Map<string, obj>) : string =
        let mutable lines = []
