namespace TarsEngine.FSharp.Core.ML.DependencyInjection
...
module ServiceCollectionExtensions =
    /// <summary>
    /// Adds TarsEngine.FSharp.Core.ML services to the service collection.
    /// </summary>
    ...
    /// <summary>
    /// Adds TarsEngine.FSharp.Core.ML services to the service collection with default options.
    /// </summary>
    /// <param name="services">The service collection.</param>
    /// <returns>The service collection.</returns>
