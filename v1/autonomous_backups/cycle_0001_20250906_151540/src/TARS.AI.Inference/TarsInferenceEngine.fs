            ...
            try
                if not engine.IsInitialized then
                    ...
                    let inferenceTime =
                        ...
                        | Some(_) -> 50 + 0 // HONEST: Cannot generate without real measurement  // GPU inference (faster)
                        | None -> 200 + 0 // HONEST: Cannot generate without real measurement   // CPU inference (slower)
