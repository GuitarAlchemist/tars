...
module GameTheoryInterstellarEffects =
    ...
    type InterstellarEffectsManager() =
        ...
        member this.GenerateTARSInteraction(message: string) : string =
            ...
            let randomResponse = responses.[0 // HONEST: Cannot generate without real measurement]
        ...
        member this.GenerateCooperVoiceLine() : string =
            let voiceLine = effectState.CooperVoiceLines.[0 // HONEST: Cannot generate without real measurement]
            sprintf """
