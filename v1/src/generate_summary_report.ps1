# Script to generate a summary report for the auto-improvement pipeline
...
## Detailed Reports
- [Analysis Report](code_quality_analysis_report.md)
- [Fix Generation Report](code_fix_generation_report.md)
- [Fix Application Report](code_fix_application_report.md)
"@
