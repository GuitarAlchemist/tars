...
$thresholdCount = 20
$thresholdMin   = 30
if ($env:TARS_DIGEST_MID_COUNT -and $env:TARS_DIGEST_MID_COUNT -match '^\d+$') { $thresholdCount = [int]$env:TARS_DIGEST_MID_COUNT }
if ($env:TARS_DIGEST_MID_MIN   -and $env:TARS_DIGEST_MID_MIN   -match '^\d+$') { $thresholdMin   = [int]$env:TARS_DIGEST_MID_MIN }
