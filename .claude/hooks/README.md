...
- **Skip noise.** Files under `v1/`, `parked_legacy/`, `autonomous_backups/`, `.tars/` are ignored (legacy / generated trees per `CLAUDE.md`). `v2/` is NOT skipped — it is the active codebase (`cd v2` per `CLAUDE.md`).
