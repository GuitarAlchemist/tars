...
{
    /// <summary>
    /// A demonstration service for Tree-of-Thought reasoning.
    /// </summary>
    public class DemoTreeOfThoughtService
    {
        private readonly ILogger<DemoTreeOfThoughtService> _logger;

        /// <summary>
        /// Initializes a new instance of the <see cref="DemoTreeOfThoughtService"/> class.
        /// </summary>
        /// <param name="logger">The logger.</param>
        public DemoTreeOfThoughtService(ILogger<DemoTreeOfThoughtService> logger)
        {
