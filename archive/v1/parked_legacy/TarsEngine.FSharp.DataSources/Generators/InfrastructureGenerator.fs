...
type InfrastructureGenerator() =
    ...
    member _.GenerateEnvironmentFile(stack: InfrastructureStack, environment: string) =
        ...
        let dateStr = DateTime.UtcNow.ToString("yyyy-MM-dd HH:mm:ss")
        sb.AppendLine($"# Date: {dateStr} UTC") |> ignore
        sb.AppendLine() |> ignore
    ...
    member _.GenerateDocumentation(stack: InfrastructureStack) =
        ...
        sb.AppendLine("---") |> ignore
        let dateStr2 = DateTime.UtcNow.ToString("yyyy-MM-dd HH:mm:ss")
        sb.AppendLine($"Generated by TARS Infrastructure Generator on {dateStr2} UTC") |> ignore
