...
public class FSharpAnalysisCommand(FSharpIntegrationService fsharpService)
{
    ...
    public Command RegisterCommands()
    {
        ...
        var analyzeMaxFiles = new Option<int>(["--max-files", "-m"], () => 50, "Maximum number of files to analyze");
        ...
        var metascriptRules = new Option<string>(["--rules", "-r"], "Path to the metascript rules file");
        var metascriptOutput = new Option<string>(["--output", "-o"], "Output directory for transformed files");
        var metascriptMaxFiles = new Option<int>(["--max-files", "-m"], () => 50, "Maximum number of files to transform");
