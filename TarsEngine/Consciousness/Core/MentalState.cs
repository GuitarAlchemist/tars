...
public class MentalState
{
    ...
    private void PruneWorkingMemory()
    {
        ...
        var itemsToRemove = _workingMemory.Count - _workingMemoryCapacity + 1;
    ...
    public Task<MentalOptimization?> OptimizeAsync()
    {
        if (!_isInitialized || !_isActive)
        {
            return Task.FromResult<MentalOptimization?>(null);
        }
        ...
        try
        {
            ...
            return Task.FromResult<MentalOptimization?>(optimization);
        }
        catch (Exception ex)
        {
    ...
    {
        var baseSignificance = type switch
        {
