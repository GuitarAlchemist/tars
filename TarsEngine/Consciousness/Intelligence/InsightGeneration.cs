...
public class InsightGeneration
{
    ...
    /// Gets the insights
    /// </summary>
    public IReadOnlyList<Insight> Insights => _insights.AsReadOnly();
    ...
    public async Task<Insight?> GenerateInsightAsync()
    {
    ...
    /// <returns>The generated insight</returns>
    private Insight? GenerateInsightByMethod(InsightGenerationMethod method)
    {
        switch (method)
        {
    ...
    /// </summary>
    /// <returns>The generated insight</returns>
    private Insight GenerateConnectionInsight()
    {
        // Get random concepts
    ...
    /// </summary>
    /// <returns>The generated insight</returns>
    private Insight GenerateRestructuringInsight()
    {
    ...
    /// </summary>
    /// <returns>The generated insight</returns>
    private Insight GenerateIncubationInsight()
    {
    ...
    public List<Insight> GetRecentInsights(int count)
    {
        return _insights
    ...
    public List<Insight> GetMostSignificantInsights(int count)
    {
        return _insights
    ...
    public List<Insight> GetInsightsByMethod(InsightGenerationMethod method, int count)
    {
        return _insights
    ...
    /// <param name="concept">The concept</param>
    /// <param name="connections">The connections</param>
    public void AddConceptConnection(string concept, string[] connections)
    {
        AddConceptConnection(concept, connections);
        
        _logger.LogInformation("Added concept connection: {Concept} with {ConnectionCount} connections", 
