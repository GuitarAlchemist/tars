...
module TemporalKnowledgeGraph =
    ...
    type TemporalGraph() =
        ...
        member this.AddFact(fact: TarsFact) =
            ...
            let currentSourceEdges =
                edgesBySource |> Map.tryFind sourceId |> Option.defaultValue []
        ...
        /// Get a node by ID
        member this.GetNode(id: string) = nodes |> Map.tryFind id
        ...
        /// Get outgoing facts/edges for an entity
        member this.GetOutgoingFacts(entity: TarsEntity) =
            let id = getEntityId entity
