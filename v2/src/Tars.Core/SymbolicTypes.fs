...
type Belief =
    ...
    /// Natural language representation for embedding/legacy support
    member this.Statement = this.Object.Value
    /// Context for the belief (mapped from Subject)
    member this.Context = this.Subject.Value
