        ...
        public async Task<int> ShowLearningStatisticsAsync()
        {
            try
            {
                ...
                var stats = new TarsCli.Services.LearningStatistics
                {
                    ...
                    TopPatterns = new List<TarsCli.Services.PatternStatistics>
                    {
                        new TarsCli.Services.PatternStatistics { Description = "Null check pattern", Score = 4.8, UsageCount = 15 },
                        new TarsCli.Services.PatternStatistics { Description = "LINQ pattern", Score = 4.5, UsageCount = 10 }
                    },
