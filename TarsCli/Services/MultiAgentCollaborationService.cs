...
using static TarsCli.Services.FSharpIntegrationService;
...
namespace TarsCli.Services
{
    ...
    public class MultiAgentCollaborationService
    {
        ...
        private readonly List<ICodeAgent> _registeredAgents = new List<ICodeAgent>();
            ...
            try
            {
                ...
                if (transformationAgents.Count == 0)
                {
                    ...
                    return new CollaborativeTransformationResult
                    {
                        ...
                        AppliedTransformations = new List<AppliedTransformation>(),
                        Success = false
                    };
                }
    ...
    public class CollaborativeTransformationResult
    {
        ...
        public List<AppliedTransformation> AppliedTransformations { get; set; } = new List<AppliedTransformation>();
        public bool Success { get; set; }
    }
