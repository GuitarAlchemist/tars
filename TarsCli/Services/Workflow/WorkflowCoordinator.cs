...
namespace TarsCli.Services.Workflow
{
    ...
    public class WorkflowCoordinator : IWorkflowCoordinator
    {
        ...
        private readonly Dictionary<string, WorkflowInstance> _workflows = new Dictionary<string, WorkflowInstance>();
        private readonly Dictionary<string, IWorkflowDefinition> _workflowDefinitions = new Dictionary<string, IWorkflowDefinition>();
