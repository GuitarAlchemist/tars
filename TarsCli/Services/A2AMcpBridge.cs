...
namespace TarsCli.Services
{
    ...
    public class A2AMcpBridge
    {
        ...
        private readonly Dictionary<string, string> _taskToMcpSessionMap = new Dictionary<string, string>();
        ...
        public void Initialize()
        {
            ...
            var agentCard = new AgentCard
            {
                ...
                {
                    new AgentSkill { Id = "code_generation", Name = "Code Generation" },
                    new AgentSkill { Id = "code_analysis", Name = "Code Analysis" },
                    new AgentSkill { Id = "metascript_execution", Name = "Metascript Execution" },
                    new AgentSkill { Id = "knowledge_extraction", Name = "Knowledge Extraction" },
                    new AgentSkill { Id = "self_improvement", Name = "Self Improvement" }
                }
            };
