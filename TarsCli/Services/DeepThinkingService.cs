    ...
    public class DeepThinkingService
    {
            ...
            string model = "llama3")
        {
            try
            {
                ...
                var topics = await GenerateRelatedTopicsAsync(baseTopic, count, model);
        ...
        /// </summary>
        private async Task<List<string>> GenerateRelatedTopicsAsync(string baseTopic, int count, string model)
        {
            try
            {
