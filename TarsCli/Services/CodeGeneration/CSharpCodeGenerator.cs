...
namespace TarsCli.Services.CodeGeneration
{
    ...
    public class CSharpCodeGenerator : ICodeGenerator
    {
        ...
        private string[] AddDocumentation(string[] lines, int lineIndex, CodeIssue issue)
        {
        ...
        /// <param name="issue">Issue to fix</param>
        /// <returns>Modified lines of code</returns>
        private string[] FixStyleIssue(string[] lines, int lineIndex, CodeIssue issue)
        {
        ...
        /// <param name="issue">Issue to fix</param>
        /// <returns>Modified lines of code</returns>
        private string[] OptimizeCode(string[] lines, int lineIndex, CodeIssue issue)
        {
            var newLines = lines.ToArray();
            var line = lines[lineIndex];
        ...
        /// <param name="issue">Issue to fix</param>
        /// <returns>Modified lines of code</returns>
        private string[] FixSecurityIssue(string[] lines, int lineIndex, CodeIssue issue)
        {
            var newLines = lines.ToArray();
            var line = lines[lineIndex];
        ...
        /// <param name="issue">Issue to fix</param>
        /// <returns>Modified lines of code</returns>
        private string[] ImproveMaintenability(string[] lines, int lineIndex, CodeIssue issue)
        {
            var newLines = lines.ToArray();
            var line = lines[lineIndex];
        ...
        /// <param name="issue">Issue to fix</param>
        /// <returns>Modified lines of code</returns>
        private string[] ReduceComplexity(string[] lines, int lineIndex, CodeIssue issue)
        {
            var newLines = lines.ToArray();
            var line = lines[lineIndex];
        ...
        /// <param name="issue">Issue to fix</param>
        /// <returns>Modified lines of code</returns>
        private string[] RemoveDuplication(string[] lines, int lineIndex, CodeIssue issue)
        {
            var newLines = lines.ToArray();
            var line = lines[lineIndex];
