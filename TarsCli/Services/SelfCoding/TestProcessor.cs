...
public class TestProcessor
{
    ...
    public async Task<TestGenerationResult> GenerateTestsForFileAsync(string filePath)
    {
        ...
        try
        {
            ...
            return TestGenerationResultAdapter.ToServiceTestGenerationResult(testGenerationResult);
        }
        catch (Exception ex)
        {
    ...
    public async Task<TestGenerationResult> GenerateTestsWithReplicaAsync(string filePath, string replicaUrl)
    {
        ...
        try
        {
            ...
            // Save the tests
            await _testGeneratorService.SaveTestsAsync(TestGenerationResultAdapter.ToTestingTestGenerationResult(testGenerationResult));

            _logger.LogInformation($"Generated tests for file with replica: {filePath}, with {TestGenerationResultAdapter.ToTestingTestGenerationResult(testGenerationResult).Tests.Count} tests");
    ...
    public async Task<List<TestRunResult>> RunTestsAsync(List<TestGenerationResult> testGenerationResults)
    {
        ...
        try
        {
            ...
            {
                var result = await RunTestsForFileAsync(TestGenerationResultAdapter.ToTestingTestGenerationResult(testGenerationResult).TestFilePath);
                if (result != null)
                {
    ...
    {
        var result = new TestingTestGenerationResult
        {
        ...
        return TestGenerationResultAdapter.ToServiceTestGenerationResult(result);
    }
    ...
    private TestRunResult ConvertResponseToTestRunResult(System.Text.Json.JsonElement response, string testFilePath)
    {
        ...
        if (response.TryGetProperty("test_results", out var testResultsElement) && testResultsElement.ValueKind == System.Text.Json.JsonValueKind.Array)
        {
            ...
            {
                var testResult = new TestingTestResult();
